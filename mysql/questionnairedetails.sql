create table eger.questionnairedetails
(
...
create index questionnairedetails_questionnaire_id_id_index
	on eger.questionnairedetails (questionnaire_id, id);

create index questionnairedetails_questionnaire_id_name_index
	on eger.questionnairedetails (questionnaire_id, name);

alter table eger.questionnairedetails
	add primary key (id);
