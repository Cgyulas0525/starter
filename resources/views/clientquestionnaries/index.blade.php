    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.indextable').DataTable({
                ...
                paging: false,
                buttons: [],
                ajax: "{{ route('clientquestionnaries.index') }}",
                columns: [
                    {title: '<a class="btn btn-primary" title="Felvitel" href="{!! route('clientquestionnaries.create') !!}"><i class="fa fa-plus-square"></i></a>',
